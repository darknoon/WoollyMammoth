...
- (void)imagePickerController:(UIImagePickerController *)picker didFinishPickingMediaWithInfo:(NSDictionary *)info;
{
	...
	ALAssetsLibraryAccessFailureBlock fail = ^(NSError *error) {
		[[[[UIAlertView alloc] initWithTitle:@"Unable to load image" message:[error localizedDescription] delegate:nil cancelButtonTitle:@"Close" otherButtonTitles:nil] autorelease] show];
